...
// Phase 3 — the real Home screen. Profile summary + Continue Creating (drafts) +
// Published Nests + a Create-New shortcut. Reads the same local NestDocument store
// the editor writes to, so a Nest you just made or published shows up here.
