    ...
    <section className="shell py-5 sm:py-8">
      ...
      <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
        <div className="flex flex-wrap rounded-full bg-white/70 p-1 shadow-sm">
          ...
          {flags.roomEngine && flags.aiDesigner && <button onClick={() => setMode("design")} className={cn("flex min-h-11 items-center gap-2 rounded-full px-5 text-sm font-black", mode === "design" ? "bg-terracotta text-white" : "text-ink/50")}><WandSparkles size={16} /> Design</button>}
