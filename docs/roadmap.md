...
animations. **Not** marketplace, **not** new major product features. **Beta Polish 1 — fullscreen
experience (shipped 2026-07-03):** every Nest surface is now **one phone screen, no page scroll** —
true one-Nest-per-viewport paging on Home, single-screen visitor/owner Nests, and asset safe zones so
furniture never overlaps the UI. Layout-only; no features. See
