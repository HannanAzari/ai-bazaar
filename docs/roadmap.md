...
**M19.1 arrival magic & atmosphere shipped 2026-07-03** on `m12-nest-platform` (preview only; **not
merged to `main`, not deployed to production**): pure polish so opening a Nest feels *magical* — the
